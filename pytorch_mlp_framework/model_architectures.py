...
class ConvolutionalProcessingBlock_bn_res(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_bn_res, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_bn_res(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_bn_res, self).__init__()
...
class ConvolutionalProcessingBlock_dropout(nn.Module):
    ...
    def build_module(self):
        ...
        self.layer_dict['bn_0'] =nn.BatchNorm2d(out.shape[1])
        out = self.layer_dict['bn_0'].forward(out)
        self.layer_dict['drop_0']= nn.Dropout(0.5)
        ...
        self.layer_dict['bn_1'] =nn.BatchNorm2d(out.shape[1])
        out = self.layer_dict['bn_1'].forward(out)
        self.layer_dict['drop_1']= nn.Dropout(0.5)
